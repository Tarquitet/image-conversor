...
# --- CLASE INSPECTOR (Mejorada con HUD rico) ---
class AdvancedInspector(tk.Toplevel):
    def __init__(self, master, img_orig, img_proc, info_orig, info_proc):
        ...
        # Procesamiento de imágenes para visualización
        self.pil_orig = img_orig.convert("RGBA")
        self.pil_proc = img_proc.convert("RGBA")
        
        # Igualar tamaños visualmente para que la cortina funcione
        # (Aunque mostramos las dimensiones reales en texto, visualmente deben coincidir)
    ...
    def create_ui(self):
        ...
        # Ayuda visual
        self.lbl_help = tk.Label(self, text="Zoom: Rueda | Mover: Click+Arrastre | Cortina: Mover Mouse", 
    ...
    def render_view(self):
        ...
        # Lógica de renderizado de cortina
        ...
        # HUD DE DATOS
        self.draw_hud(draw, 20, 20, "ORIGINAL", self.txt_orig, align="left", color=(220, 220, 220))
...
class UniversalOmegaConverter:
    def __init__(self, root):
        self.root = root
        self.root.title("Tarquitet - OMEGA Converter V2")
    ...
    def build_ui(self):
        ...
        header.pack(fill="x")
        ttk.Label(header, text="OMEGA CONVERTER V2", font=("Helvetica", 18, "bold"), bootstyle="primary").pack(side="left")
        ...
        # BARRA DE INFO INFERIOR (CON COLOR DINÁMICO)
        self.lbl_info = ttk.Label(f_prev, text="-", font=("Consolas", 11, "bold"), bootstyle="inverse-secondary", anchor="center")
    ...
    def open_inspector(self, event=None):
        ...
        try:
            ...
            # DATOS RICOS PARA EL INSPECTOR
            orig_s = os.path.getsize(self.current_item.path)
            new_s = len(self.processed_buffer)
