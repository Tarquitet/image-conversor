...
class UniversalOmegaConverter:
    def __init__(self, root):
        self.root = root
        self.root.title("Tarquitet - OMEGA Converter V3 (Stable)")
    ...
    def build_ui(self):
        ...
        ttk.Label(header, text="OMEGA CONVERTER V3", font=("Helvetica", 18, "bold"), bootstyle="primary").pack(side="left")
    ...
    def on_ui_change(self, e=None):
        ...
        # Debounce to prevent freeze on slider drag
    ...
    def run_batch(self, out_dir):
        for i, item in enumerate(self.items):
            try:
                # Update label from thread safely
